...
function Modal() {
    ...
    const uploadPost = async () => {
        if(loading) return;
        setLoading(true);
        //Create a post and add to firestore 'posts' collection and get id
                                ...
                                <div className="mt-3 text-center sm:mt-5">
                                    ...
                                    <div className="mt-2">
                                        <input
                                         type="text"
                                         ref={captionRef} 
                                         className='border-none focus:ring-0 w-full text-center' placeholder='Please enter a caption...' 
                                        />
                                    </div>
                                </div>
                            </div>
